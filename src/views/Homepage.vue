            ...
            <div style="max-width: 59rem !important;min-width: 20rem !important">
                ...
                <el-form ref="form" :model="form" :inline="true">
                    ...
                    <el-form-item style="height: auto !important;">
                        <el-row class="label-emphasize" style="margin-left:1rem">
                            <!-- <el-form-item label="出院诊断old" style="width:26rem; margin-right:1rem !important; height: auto !important">
                            ...
                            <el-form-item label="出院诊断" style="width:26rem; margin-right:1rem !important; height: auto !important">
                                <el-select
                                v-model="form.main_diagnosis.release"
                                multiple
                                filterable
                                remote
                                placeholder="添加诊断"
                    ...
                    >
                        ...
                        <el-row justify="end" style="width:100%">
                            <el-button class="add-diag" style="margin-right:.5rem" @click="addDiag">+ 其他诊断</el-button>
                        </el-row>
                    ...
                    <el-row justify="end" style="margin-bottom:5rem; width:100%">
                        <el-form-item>
                            <el-button 
                            class="cancel"
                            @click="cancelForm"

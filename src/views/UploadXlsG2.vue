        ...
        <div style="max-width:59rem !important; margin-left:10% !important; margin-right:auto !important;">
            <el-row justify="center">
                <div class="title" style="margin: 3rem 0">
                    <h1>XLS {{type_name.split('').join(' ')}} 标 准 上 传</h1>
                </div>
            </el-row>
            <el-row justify="center">
                <el-upload
                ref="upload"
                action="http://127.0.0.1:8000/api/v1/upload-std/xls-g2/"
                accept=".xls,.xlsx"
                :data={type:type}
                :limit="1"
                ...
                >
                    ...
                    <div class="el-upload__tip text-red" style="margin-top:.7rem">
                        ...
                        placement="bottom">
                            ...
                            <el-link :href="''+proxy.$api+'upload-std/g2-xls-example'" rel="external nofollow">.xls</el-link>
                        </el-tooltip>
                        或
                        <el-tooltip
                        class="box-item"
                        ...
                        placement="bottom">
                            ...
                            <el-link :href="''+proxy.$api+'upload-std/g2-xlsx-example'" rel="external nofollow">.xlsx</el-link>
                        </el-tooltip>
                        文件
                    </div>
                    </template>
